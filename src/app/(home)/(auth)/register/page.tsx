  ...
  return (
    <>
      {isRoleSubmitted && selectedRole.length ? (
        ...
        <div className="flex flex-col justify-center items-center min-h-svh text-black">
          <div className="flex justify-center items-center">
            <Logo variant="black" className="w-full text-center" />
          </div>
          <div className="my-5 w-4/5 sm:w-1/2 lg:w-1/4 sm:mx-auto bg-foreground shadow rounded-lg p-6 space-y-10 flex flex-col justify-between">
